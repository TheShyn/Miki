        ...
        <div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                    <div className="h-5 bg-yellow-300 rounde w-[70%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                    <div className="h-5 bg-yellow-300 rounde w-[17%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                    <div className="h-5 bg-yellow-300 rounde w-[8%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                    <div className="h-5 bg-yellow-300 rounde w-[4%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                    <div className="h-5 bg-yellow-300 rounde w-[1%]"></div>
                </div>
