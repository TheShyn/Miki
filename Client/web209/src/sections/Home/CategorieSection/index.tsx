...
export default function CateSection() {
    return (
        <div className=" mt-[100px] md:mt-[150px] flex justify-center mx-auto">
            ...
            <div className="flex gap-[20px] text-white md:flex-row flex-col md:items-center flex-wrap font-bold text-2xl">
                <div className="flex flex-col lg:mb-[0] mb-[20px]">
                    <div className="flex lg:flex-row md:flex-col ">
                        <div className="relative pr-[20px] lg:mb-[31px] drop-shadow-product">
                            <p className="absolute left-[50%] tranform transform -translate-x-1/2 text_ACenter top-[80%] text-[12px] lg:text-[24px] ">Nhẫn</p>
                        ...
                        <div className="relative pr-[20px] drop-shadow-product h-[254px]">
                            <p className="absolute left-[50%] tranform transform -translate-x-1/2 text_ACenter top-[80%] text-[12px] lg:text-[24px] ">Đồng hồ</p>
                    ...
                    <div className=" flex lg:flex-row lg:gap-[0]  md:flex-col">
                        <div className="relative pr-[20px] drop-shadow-product">
                            <p className="absolute left-[50%] tranform transform -translate-x-1/2 text_ACenter top-[80%] text-[12px] lg:text-[24px] ">Lắc tay</p>
                        ...
                        <div className="relative pr-[20px] drop-shadow-product">
                            <p className="absolute left-[50%] tranform transform -translate-x-1/2 text_ACenter top-[80%] text-[12px] lg:text-[24px] ">Dây chuyền</p>
                ...
                <div className="relative drop-shadow-product flex">
                    <p className="absolute left-[50%] tranform transform -translate-x-1/2 text_ACenter top-[80%] text-[12px] lg:text-[24px] ">Bông tai</p>
